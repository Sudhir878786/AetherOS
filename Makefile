...
kern:
	...
	gcc -m32 -g -ffreestanding -c kernel/memory.c -o kernel/memory.o
	gcc -m32 -g -ffreestanding -c kernel/process.c -o kernel/process.o
	gcc -m32 -g -ffreestanding -c kernel/filesystem.c -o kernel/filesystem.o
	gcc -m32 -g -ffreestanding -c kernel/network.c -o kernel/network.o
...
link:
	ld -m elf_i386 -Ttext 0x1000 -o kernel.bin loader.o main.o $(wildcard include/*.o cpu/*.o kernel/*.o user/shell/*.o user/taskbar/*.o)

run:
	qemu-system-x86_64 -kernel kernel.bin
clean:
	rm -f *.o include/*.o cpu/*.o kernel/*.o user/shell/*.o user/taskbar/*.o
